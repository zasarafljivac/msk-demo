...
export class NetworkConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: NetworkConstructProps = {}) {
    ...
    this.mskSg = new SecurityGroup(this, "MskSg", {
      vpc: this.vpc,
      allowAllOutbound: true,
    });
    this.lambdasSg = new SecurityGroup(this, "LambdasSg", {
      vpc: this.vpc,
    ...
    this.proxySg.addIngressRule(
      this.lambdasSg,
      Port.tcp(3306),
      "Lambda to Proxy 3306",
    );
    this.mskSg.addIngressRule(
      this.lambdasSg,
      Port.tcp(9098),
      "Kafka broker (IAM/TLS)",
    );
